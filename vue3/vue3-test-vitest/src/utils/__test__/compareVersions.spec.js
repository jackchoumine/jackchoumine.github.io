 ...
 * @LastEditTime: 2025-08-12 22:30:42
...
describe('compareVersions', () => {
  ...
  it('应该正确处理混合标识符（数字和字符串）', () => {
    // 数字标识符的优先级低于字符串标识符
    expect(compareVersions('1.0.0-alpha.0', '1.0.0-alpha.beta')).toBe(-1)
    expect(compareVersions('1.0.0-alpha.beta', '1.0.0-alpha.0')).toBe(1)
  })
